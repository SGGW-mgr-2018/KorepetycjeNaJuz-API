...
namespace KorepetycjeNaJuz.Core.Interfaces
{
    public interface ICoachLessonService
    {
        ...
        IEnumerable<CoachLessonCalendarDTO> GetCoachLessonsCalendar(CoachLessonCalendarFiltersDTO filters, int currentUserId);
        IEnumerable<CoachLessonHistoryDTO> GetCoachLessonsHistory(int userId);
